...
class ShippingRateCalculatorTest {
    ...
    void shouldCalculateStandardRate() {
        ...
        StepVerifier.create(
            calculator.calculateRate(request, "STANDARD")
    ...
    void shouldCalculateExpressRate() {
        ...
        StepVerifier.create(
            calculator.calculateRate(request, "EXPRESS")
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
            .assertNext(rate -> {
    ...
    void shouldCalculateOvernightRateForDomestic() {
        ...
        StepVerifier.create(
            calculator.calculateRate(request, "OVERNIGHT")
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
            .assertNext(rate -> {
                assertThat(rate.getCarrier()).isEqualTo("FedEx");
    ...
    void shouldNotOfferOvernightForInternational() {
        ...
        StepVerifier.create(
            calculator.calculateRates(request).collectList()
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
            .assertNext(rates -> {
    ...
    void shouldIncreaseRateWithWeight() {
        ...
        StepVerifier.create(
            calculator.calculateRate(lightRequest, "STANDARD")
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
            .assertNext(lightRate -> {
                StepVerifier.create(
                    calculator.calculateRate(heavyRequest, "STANDARD")
                        .contextWrite(TenantContext.withTenantId("test-tenant"))
                )
    ...
    void shouldApplyDistanceMultiplierForInternational() {
        ...
        StepVerifier.create(
            calculator.calculateRate(domesticRequest, "STANDARD")
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
            .assertNext(domesticRate -> {
                StepVerifier.create(
                    calculator.calculateRate(internationalRequest, "STANDARD")
                        .contextWrite(TenantContext.withTenantId("test-tenant"))
                )
    ...
    void shouldHandleInvalidServiceLevel() {
        ...
        StepVerifier.create(
            calculator.calculateRate(request, "INVALID")
                .contextWrite(TenantContext.withTenantId("test-tenant"))
        )
